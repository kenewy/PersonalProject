...
<table id="myTable">
    <tr class="ligne-coloree1">
        <th>Date</th>
        <th class="cellule premiere-cellule"><strong>{noms_jours[0]}</strong><br>Aujourd'hui</th>
    ...
    <tr class="ligne-coloree2">
        <th>Image</th>
        <th class="cellule premiere-cellule"><img src ="{noms_urls[0]['url']}"></a><br>
        {noms_urls[0]['nom']}</th>
    ...
    <tr class="ligne-coloree1">
        ...
        <th class="cellule premiere-cellule">{temperature_max_maj[0]} °C</th>
        <th>{temperature_max_maj[1]} °C</th>
        <th>{temperature_max_maj[2]} °C</th>
        <th>{temperature_max_maj[3]} °C</th>
    </tr>
    <tr class="ligne-coloree1">
        <th>Température minimale</th>
        <th class="cellule premiere-cellule">{temperature_min_min[0]} °C</th>
        <th>{temperature_min_min[1]} °C</th>
        <th>{temperature_min_min[2]} °C</th>
        <th>{temperature_min_min[3]} °C</th>
    </tr>
    <tr class="ligne-coloree1">
        <th>Vitesse du vent maximale</th>
        <th class="cellule premiere-cellule">{vent_arr[0]} km/h</th>
    ...
    <tr class="ligne-coloree1">
        ...
        <th class="cellule premiere-cellule">{precipitations[0]} mm</th>
