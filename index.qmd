...
<table id="myTable" title="Date">
    ...
    <tr class="couleur2" title="Temps">
        <th title="{noms_urls[0]['nom']}" class="bordure2 bordure">
            <img src ="{noms_urls[0]['url']}"></a>
            <br>{noms_urls[0]['nom']}
        </th>
        <th title="{noms_urls[1]['nom']}">
            <img src ="{noms_urls[1]['url']}"></a>
            <br>{noms_urls[1]['nom']}
        </th>
        <th title="{noms_urls[2]['nom']}">
            <img src ="{noms_urls[2]['url']}"></a>
            <br>{noms_urls[2]['nom']}
        </th>
        <th title="{noms_urls[3]['nom']}">
            <img src ="{noms_urls[3]['url']}"></a>
            <br>{noms_urls[3]['nom']}
        </th>
    </tr>
...
Météo de Montpellier pour les 4 prochains jours, aujourd'hui compris, affichant pour chaque journée (colonne):
<ol>
    <li>la date,</li>
    <li>l'icône WMO (World Meteorological Organization) provenant du site meteoblue.com en format svg avec la description correspondante,</li>
    <li>les températures minimale et maximale en valeurs entières en degrés Celsius,</li>
    <li>la vitesse du vent maximale en valeur entière en kilomètres par heure (seule donnée disponible) et sa direction cardinale par une flèche,</li>
